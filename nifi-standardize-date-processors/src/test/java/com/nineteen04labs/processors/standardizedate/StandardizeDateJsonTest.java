...
public class StandardizeDateJsonTest {
    ...
    public void testNoEncryption() throws IOException {
        ...
        runner.setProperty(StandardizeDateProperties.HASH_ALG, "SHA-512");
    ...
    private void testEncryption(final String hashAlgorithm, final Path encryptedFile) throws IOException {
        runner.setProperty(StandardizeDateProperties.FIELD_NAMES, "card_number,last_name");
        runner.setProperty(StandardizeDateProperties.FLOW_FORMAT, "JSON");
        runner.setProperty(StandardizeDateProperties.HASH_ALG, hashAlgorithm);
